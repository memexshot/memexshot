...
class TwitterBot:
    def __init__(self):
        ...
        self.max_daily_per_user = 99  # TEST MODE: Increased limit
        self.min_followers = 0  # TEST MODE: Disabled follower check
    ...
    def parse_tweet(self, tweet_text):
        ...
        Format: Perfecto $TICKER @memeXshot
        """
        # Remove extra spaces and newlines
        text = ' '.join(tweet_text.split())
        
        # TEST MODE: Pattern to match: Perfecto TICKER @memeXshot
        pattern = rf'Perfecto\s+\$?([A-Za-z0-9]+)\s+@{self.bot_username}'
    ...
    def add_to_queue(self, tweet, ticker, author=None, followers_count=0, includes=None):
        ...
        try:
            ...
            queue_data = {
                ...
                'ticker': ticker,
                'name': ticker,  # Same as ticker as requested
    ...
    def search_tweets(self):
        ...
        try:
            # TEST MODE: Search query for "Perfecto"
            query = f'"Perfecto" "@{self.bot_username}" -is:retweet has:images'
    ...
    def run(self):
        ...
        self.log(f"🔍 TEST MODE: Monitoring for: Perfecto @{self.bot_username}")
